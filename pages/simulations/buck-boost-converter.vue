      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center mb-8">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300 mb-6">
            Interactive DC-DC converter simulation with step-up/down capability and inverted output
          </p>
          <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg p-4 inline-block">
            <div class="animated-formula">
              <span class="formula-part output">Vout</span>
              <span class="formula-operator">=</span>
              <span class="formula-part operator">-</span>
              <span class="formula-part input">Vin</span>
              <span class="formula-operator">×</span>
              <span class="formula-part d-duty">D</span>
              <span class="formula-operator">/</span>
              <span class="formula-part">(1-D)</span>
            </div>
          </div>
        </div>
      </div>
...
export default {
  name: 'BuckBoostConverterPage',
  setup() {
    useHead({
      title: 'Buck-Boost Converter Simulation - Cyno Electric',
      meta: [
        { name: 'description', content: 'Interactive buck-boost converter simulation with step-up/down capability. Visualize switching behavior, calculate output voltage, and learn about inverted output DC-DC conversion.' },
        { name: 'keywords', content: 'buck-boost converter, DC-DC converter, inverted output, switching converter, power electronics simulation' }
      ]
    })
